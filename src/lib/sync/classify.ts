...
const DISCIPLINE_KEYWORDS: Record<DisciplineTag, string[]> = {
  electrical: ["electrical engineer", "electrical engineering", "power electronics", "circuit design", " ee intern"],
  computerEngineering: ["computer engineer", "computer engineering", "computer hardware", "soc design", "vlsi"],
  ...
  controls: ["controls engineer", "automation engineer", "plc programming", "scada"],
